...
package com.example.dkdk6.toktokplay.Activity.dtw;

import com.example.dkdk6.toktokplay.Activity.timeseries.TimeSeries;
import com.example.dkdk6.toktokplay.Activity.util.DistanceFunction;
import com.example.dkdk6.toktokplay.Activity.matrix.ColMajorCell;
...
public class DTW
{
   ...
   public static double calcWarpCost(WarpPath path, TimeSeries tsI, TimeSeries tsJ, DistanceFunction distFn)
   {
      ...
      {
         final com.example.dkdk6.toktokplay.Activity.matrix.ColMajorCell currWarp = path.get(p);
