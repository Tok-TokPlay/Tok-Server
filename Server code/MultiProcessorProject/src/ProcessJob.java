...
public class ProcessJob implements Runnable{
	...
	public void run()	{
		...
		String[] processJob = {"/usr/local/java/jdk1.8.0_131/bin/java","-jar", "/home/sshrik/Workspace/java/MultiProcessorProject/src/ComparingJob.jar", dbDirectory, fileName, userBeat};
		try {
