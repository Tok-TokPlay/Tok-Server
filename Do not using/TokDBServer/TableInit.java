...
public class TableInit { 
	...
	public void readMusicHeader(){ 
		...
		File path = new File("C:\\Users\\재상\\Desktop\\musicFile");
		...
		for(int i=0; i<fileList.length; i++){
			File f = new File("C:\\Users\\재상\\Desktop\\musicFile\\" + fileList[i]);	//set the music file directory in here
			RandomAccessFile rf;
			try {
				...
				try{
					...
					//For check
					System.out.println("노래제목--" + music);	
					System.out.println("가 수--" + singer);	
				} catch (Exception e){
